...
class Sidebar(QtWidgets.QWidget):
    ...
    def __init__(self, stacked_widget):
        ...
        self.pixmap = QtGui.QPixmap(r'Dropbox\MP\Program\gui_pictures\sidebar\logo_face_recognition.png') # Nahrání obrázku do paměti
        ...
        # Vytvoří tlačítka
        self.sidebar_button_about = self.create_sidebar_button("   O Aplikaci",r'Dropbox\MP\Program\gui_pictures\sidebar\about.png', 0)
        self.sidebar_button_photo_upload = self.create_sidebar_button("   Nahrát Fotku",r'Dropbox\MP\Program\gui_pictures\sidebar\photo_upload.png', 1)
        self.sidebar_button_live_recording = self.create_sidebar_button("   Živé Snímání",r'Dropbox\MP\Program\gui_pictures\sidebar\live_recording.png', 2)
        self.sidebar_button_add_face = self.create_sidebar_button("   Přidat Obličej",r'Dropbox\MP\Program\gui_pictures\sidebar\add_face.png', 3)
